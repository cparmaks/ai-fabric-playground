...
clab deploy -t ai-fabric-2tierv1.yaml
...
#9 [Wait for Commit Confirmed on SRL nodes]
log_info "...Waiting for Commit Confirmed on SRL nodes..."
sleep 75

#10 [Accept deviations]
accept_deviations() {
...
#     if docker exec -it 2tier-gpu-01 ping6 -c 3 fd00:1:1:1:0:1:0:1; then
...
#     total_tests=$((total_tests + 1))
#     if docker exec -it 2tier-gpu-01 ping6 -c 3 fd00:1:1:1:0:2:0:2; then
...
#     total_tests=$((total_tests + 1))
#     if docker exec -it 2tier-gpu-01 ping6 -c 3 fd00:1:2:1:0:3:0:2; then
...
#     total_tests=$((total_tests + 1))
#     if docker exec -it 2tier-gpu-01 ping6 -c 3 fd00:2:5:1:0:5:0:2; then
