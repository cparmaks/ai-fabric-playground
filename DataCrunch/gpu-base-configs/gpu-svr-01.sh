...
ip -6 addr afd00:1:2:1:0:3:0:2/96 dev eth7.1
ip link set eth7.1 up

#PXN#8
#======================================================================#
ip link add link eth8 name eth8.1 type vlan id 1
ip -6 addr add fd00:1:2:1:0:4:0:2/96 dev eth8.1
ip link set eth8.1 up


########################### Static Routes ##############################
#======================================================================#
ip -6 route add fd00:1:2:1:0:5::/96 via fd00:1:2:1:0:1:0:1 dev eth5.1
ip -6 route add fd00:1:2:1:0:6::/96 via fd00:1:2:1:0:2:0:1 dev eth6.1
ip -6 route add fd00:1:2:1:0:7::/96 via fd00:1:2:1:0:3:0:1 dev eth7.1
ip -6 route add fd00:1:2:1:0:8::/96 via fd00:1:2:1:0:4:0:1 dev eth8.1
