...
# Static Routes
#======================================================================#
ip -6 route add b:/96 via fd00:1:1:1:0:1:0:1 dev eth1.1
ip -6 route add fd00:1:1:1:0:6::/96 via fd00:1:1:1:0:2:0:1 dev eth2.1
ip -6 route add fd00:1:1:1:0:7::/96 via fd00:1:1:1:0:3:0:1 dev eth3.1
ip -6 route add fd00:1:1:1:0:8::/96 via fd00:1:1:1:0:4:0:1 dev eth4.1